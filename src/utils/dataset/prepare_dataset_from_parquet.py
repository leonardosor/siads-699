...
Use the new unified script instead:
  python src/utils/dataset/prepare_dataset.py parquet [options]
...
def main() -> None:
    ...
    print("Consider using: python src/utils/dataset/prepare_dataset.py parquet")
    print("=" * 70)
    print()
