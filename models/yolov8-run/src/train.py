...
DEFAULT_DATA_CONFIG = KIT_ROOT / "src" / "finance-image-parser.yaml"
DEFAULT_WEIGHTS = KIT_ROOT / "models" / "yolov8n.pt"
DEFAULT_PROJECT = KIT_ROOT / "runs" / "detect"
