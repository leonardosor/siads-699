...
Use the new unified script instead:
  python src/utils/dataset/prepare_dataset.py augmented [options]
...
def main() -> None:
    ...
    print("Consider using: python src/utils/dataset/prepare_dataset.py augmented")
    print("=" * 70)
    print()
